...
void update_sphere(float x, float y, float z){
	...
	tex[0] = atan2( z , x )/(2*PI);
  	if(tex[0] < 0)
  	  ...
  	  tex[0] = 1-tex[0];
  	tex[1] = 2*asin(y/(r/(512.0/14.0)))/PI;
...
int main() {
	...
	for(float y = -145.0; y<145.0; y += 5.0){
		r1 = sqrt(r*r - y*y);
		r2 = sqrt(r*r - (y+5)*(y+5));
		for(int i = 0; i<=8; i++){
		...
		for(int i = 0; i<32;i++){
			...
			cout<<norm_x(256+circle_s[i+1][0])<<" "<<norm_y(256-(y+5))<<" "<<norm_z(circle_s[i+1][1])<<" "<<c1<<" "<<c2<<" "<<c3<<" "<<normal[0]<<" "<<normal[1]<<" "<<normal[2]<<" "<<tex[0]<<" "<<tex[1]<<endl;
			update_sphere(norm_x(256+circle_b[i+1][0]),norm_y(256-y),norm_z(circle_b[i+1][1]));
			cout<<norm_x(256+circle_b[i+1][0])<<" "<<norm_y(256-y)<<" "<<norm_z(circle_b[i+1][1])<<" "<<c1<<" "<<c2<<" "<<c3<<" "<<normal[0]<<" "<<normal[1]<<" "<<normal[2]<<" "<<tex[0]<<" "<<tex[1]<<endl;
			update_sphere(norm_x(256+circle_b[i][0]),norm_y(256-y),norm_z(circle_b[i][1]));
			cout<<norm_x(256+circle_b[i][0])<<" "<<norm_y(256-y)<<" "<<norm_z(circle_b[i][1])<<" "<<c1<<" "<<c2<<" "<<c3<<" "<<normal[0]<<" "<<normal[1]<<" "<<normal[2]<<" "<<tex[0]<<" "<<tex[1]<<endl;
			update_sphere(norm_x(256+circle_b[i][0]),norm_y(256-y),norm_z(circle_b[i][1]));
			cout<<norm_x(256+circle_b[i][0])<<" "<<norm_y(256-y)<<" "<<norm_z(circle_b[i][1])<<" "<<c1<<" "<<c2<<" "<<c3<<" "<<normal[0]<<" "<<normal[1]<<" "<<normal[2]<<" "<<tex[0]<<" "<<tex[1]<<endl;
			update_sphere(norm_x(256+circle_s[i][0]),norm_y(256-(y+5)),norm_z(circle_s[i][1]));
			cout<<norm_x(256+circle_s[i][0])<<" "<<norm_y(256-(y+5))<<" "<<norm_z(circle_s[i][1])<<" "<<c1<<" "<<c2<<" "<<c3<<" "<<normal[0]<<" "<<normal[1]<<" "<<normal[2]<<" "<<tex[0]<<" "<<tex[1]<<endl;
			update_sphere(norm_x(256+circle_s[i+1][0]),norm_y(256-(y+5)),norm_z(circle_s[i+1][1]));
			cout<<norm_x(256+circle_s[i+1][0])<<" "<<norm_y(256-(y+5))<<" "<<norm_z(circle_s[i+1][1])<<" "<<c1<<" "<<c2<<" "<<c3<<" "<<normal[0]<<" "<<normal[1]<<" "<<normal[2]<<" "<<tex[0]<<" "<<tex[1]<<endl;
			cout<<endl;
		}
