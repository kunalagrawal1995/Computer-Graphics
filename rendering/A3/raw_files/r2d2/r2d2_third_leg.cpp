...
int main() {
	...
	p3.x=norm_x(256.0-thickness/2.0);p3.y=norm_y(256.0-(-height));p3.z=norm_z(thickness/2.0);
	p4.x=norm_x(256.0+thickness/2.0);p4.y=norm_y(256.0-(-height));p4.z=norm_z(thickness/2.0);
	...
	p7.x=norm_x(256.0-thickness/2.0);p7.y=norm_y(256.0-(-height));p7.z=norm_z(-thickness/2.0);
	p8.x=norm_x(256.0+thickness/2.0);p8.y=norm_y(256.0-(-height));p8.z=norm_z(-thickness/2.0);
